...
export default function About({ about, profile }) {
  return (
    <section id="about" className="py-24 px-8 bg-bg-alt">
      ...
      <div className="section-container grid grid-cols-1 md:grid-cols-[4fr_6fr] gap-8 items-start">
      ...
      {/* 하단 Contact 버튼 */}
      <div className="section-container flex flex-row flex-wrap justify-center gap-2 mt-12">
        <a href={profile.contacts.resumeUrl} target="_blank" rel="noopener noreferrer" className="contact-btn group">
          Resume
          <span className="opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all duration-200 text-xs">↗</span>
        </a>
        <a href={`mailto:${profile.contacts.email}`} className="contact-btn group">
          Email
          <span className="opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all duration-200 text-xs">↗</span>
        </a>
        <a href={`https://${profile.contacts.github}`} target="_blank" rel="noopener noreferrer" className="contact-btn group">
          GitHub
          <span className="opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all duration-200 text-xs">↗</span>
        </a>
      </div>
